...
class KecamatanController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        $kecamatan->save();
        return redirect()->route('admin.kecamatan.index')->with('toast_success', 'Kecamatan berhasil dibuat!');
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        $kecamatan->id_kota = $request->id_kota;
        $kecamatan->save();
        return redirect()->route('admin.kecamatan.index')->with('toast_success', 'Kecamatan berhasil diedit!');
    }
