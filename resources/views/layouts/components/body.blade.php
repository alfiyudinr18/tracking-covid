        ...
        <div class="card">
            <div class="card-body m-b-0">
                ...
                <div class="d-flex align-items-center flex-row m-t-30">
                    <h1 class="font-light"><i class="wi wi-day-sleet"></i> <span>35<sup>°</sup></span>
                    </h1>
                </div>
            </div>
        ...
        <div class="card">
            ...
            <div class="comment-widgets scrollable" style="height:430px;">
                ...
                <div class="d-flex flex-row comment-row m-t-0">
                    <div class="p-2">
                        <img src="{{ asset('assets/assets/images/users/1.jpg') }}" alt="user" width="50"
                ...
                <div class="d-flex flex-row comment-row">
                    <div class="p-2">
                        <img src="{{ asset('assets/assets/images/users/4.jpg') }}" alt="user" width="50"
                            class="rounded-circle">
                    </div>
                ...
                <div class="d-flex flex-row comment-row">
                    <div class="p-2">
                        <img src="{{ asset('assets/assets/images/users/5.jpg') }}" alt="user" width="50"
                            class="rounded-circle">
                    </div>
                    <div class="comment-text w-100">
                ...
                <div class="d-flex flex-row comment-row m-t-0">
                    <div class="p-2">
                        <img src="{{ asset('assets/assets/images/users/2.jpg') }}" alt="user" width="50"
                            class="rounded-circle">
                    </div>
                    <div class="comment-text w-100">
